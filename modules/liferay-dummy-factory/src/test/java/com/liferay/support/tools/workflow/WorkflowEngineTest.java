		...
		functions.put(
			...
			new DefaultWorkflowFunction(
				new WorkflowFunctionDescriptor(
					...
					"WorkflowStepResult"),
				request -> WorkflowStepResult.success(
					1,
			...
			new DefaultWorkflowFunction(
				...
				request -> {
					...
					return WorkflowStepResult.success(
						1, List.of(Map.of("layoutId", 501L)), Map.of());
				}));
		...
		Map<String, WorkflowFunction> functions = Map.of(
			...
			new DefaultWorkflowFunction(
				new WorkflowFunctionDescriptor(
					...
					"WorkflowStepResult"),
				request -> WorkflowStepResult.failure(
					1, 0, 1, "company failed", List.of(), Map.of())),
			"site.create",
			new DefaultWorkflowFunction(
				new WorkflowFunctionDescriptor(
					"site.create", "create site", List.of(), "WorkflowStepResult"),
				request -> WorkflowStepResult.success(
					1, List.of(Map.of("groupId", 200L)), Map.of())));
