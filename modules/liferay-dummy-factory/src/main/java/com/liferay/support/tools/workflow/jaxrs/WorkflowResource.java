...
public class WorkflowResource {
	...
	private WorkflowPlan _toPlan(WorkflowRequestDto workflowRequestDto) {
		...
		Map<String, WorkflowStepDefinition> stepsById = new LinkedHashMap<>();
		...
		for (WorkflowStepDto workflowStepDto : workflowRequestDto.steps()) {
			...
			stepDefinitions.add(workflowStepDefinition);
			stepsById.put(workflowStepDefinition.id(), workflowStepDefinition);
		}
